...
<div align="center">
  <table width="800" border="0" cellspacing="0" cellpadding="0">
	...
	if(@$_POST['submit'])	
	{
	 ...
	 $acctype='premium';
	 $query = "SELECT * from accounts where username = '$username' and company = '$company'";
	...
	"; 
          ...
          echo"
			 ...
			 <td><a href='pcreate.php?keyword=$keyword&shortcode=$shortcode&user=$username&price=$price&compan=$company&id=$id'>Create Service</a></td>
			 </tr>";
	...
	<table valign="middle" >
	<tr><td valign="middle" align="center" colspan="2"><b><u>Create a SMS Competition Service</u></b><br>&nbsp;</td></tr>
	<tr>
