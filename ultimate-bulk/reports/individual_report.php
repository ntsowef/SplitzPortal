...
<html>
    ...
    <body>
       ...
       $sql1 = "SELECT bc.category as category, bv.cash_received, bv.msisdn, bv.date_loggedin from uma_votes_transaction bv, bam_categories bc where bv.user_id='$username' AND bc.id = bv.category";
       // echo $sql1;
