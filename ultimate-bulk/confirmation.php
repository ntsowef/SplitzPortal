...
window.history.forward();
    ...
    <body onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="" bgcolor="#99CC66">
        ...
        echo "Ultimate FM would like to confirm that <b>".$team."</b> was allocate <b>".$votes." votes</b> from the purchase of M".$amount.", by this number (".$msisdn."). Text message is sent to the cellphone number as a confirmation, thank you. <br>";
