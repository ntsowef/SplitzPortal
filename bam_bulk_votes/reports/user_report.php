        ...
        include'connect.php';
            ...
            if(isset($_POST['cmdadd'])){
                 ...
                 if ($status == "Ok"){
                       ...
                       $select = "SELECT bv.user_id, bc.category, bv.cash_received, bv.msisdn, bv.nominee, bv.date_loggedin from uma_votes_transaction bv, ultimate_categories bc where bv.user_id='$agent'  and  (bv.date_loggedin >= '$dateFrom' and bv.date_loggedin<='$dateto') and bc.id = bv.category";
          //   echo $select;
