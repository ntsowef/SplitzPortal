    ...
    <body>
        ...
        $result=mysql_query($sql) or die('Unable to select from cell_poll');
          ...
          if ($num_record == 0){
                ...
                echo "<tr><td class='helpHed' colspan='3'>Ultimate FM Music Award Votes tracker</td></tr>";
              //  echo "<TR> <td class='helpHed'>Poll #</td><td class='helpHed'>Poll Name</td><td class='helpHed'>View</td><td class='helpHed'></td><td class='helpHed'>Total Votes</td>";                
               echo "<TR> <td class='helpHed'>Poll #</td><td class='helpHed'>Poll Name</td><td class='helpHed'>View</td><td class='helpHed'></td>";                
