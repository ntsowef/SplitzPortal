...
//$qst_id=11; // Change this ID for a different poll
$count=$dbo->prepare("select * from mobile_poll where id=:qst_id");
...
<table border='1' cellspacing='0'  bordercolor='#ffff00' width='320' id='AutoNumber1'>
  <tr>
    <td width='100%' bgcolor='#ffff00'><font face='Verdana' size='2' >$query->quest</font></td>
  </tr>
  <tr>
    <td width='100%' >
...
?>
    ...
    <a href=poll_display.php?poll_id=<?php echo $qst_id; ?>>Display Poll</a> &nbsp;&nbsp;|&nbsp;&nbsp;<a href=view_poll_result.php?poll_id=<?php echo $qst_id; ?>>View Result</a>
