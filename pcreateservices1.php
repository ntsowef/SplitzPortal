  ...
  <table width="800" border="0" cellspacing="0" cellpadding="0">
	...
	//	$result=mysql_query($sql) or die('Failed to insert premium_services'.mysql_error());
		...
		echo "<br>";
                ...
                //echo $sqlInsert;
                $res = mysql_query($sqlInsert) or die("Couldn't competition_weekly_winner ");
	...
	<table valign="middle" >
	<tr><td valign="middle" align="center" colspan="2">Please select dates to check for a Winner on Weekly Cruise Competition/Campaign<br>&nbsp;</td></tr>
