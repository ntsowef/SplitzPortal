       ...
       // echo " something is nice";
		  ...
		  $status="False";
             ...
             if ($status == "Ok"){
              ...
              $select = "SELECT bb.user_id, bc.category as category, bb.cash_received, bb.date_loggedin, bb.nominee from uma_votes_transaction bb, ultimate_categories bc where bb.category='$keyword' AND bc.category_code = bb.category";
