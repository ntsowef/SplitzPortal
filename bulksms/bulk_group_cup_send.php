...
//{ 
   ...
   if($credits>0)
   {     $team_name='';
	 if (strlen($sms_group) <= 15){
                      if (strpos($sms_group," ") !== false) {                           
                          $team_name = str_replace(" ", "_", $sms_group);
                      }else{
                          $team_name = $sms_group;
                      }       
                   }
              ...
              $query = "SELECT  distinct(cell_no) from team_".$team_name;
             // echo $query;
