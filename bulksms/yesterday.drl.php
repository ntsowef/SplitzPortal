...
?>
<html>
  <title>Yesterday Delivery Report  <?php echo $company; ?></title>
	<head>
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				var dataTable = $('#nomination-grid').DataTable( {
					...
					"serverSide": true,
					"ajax":{
						url :"yesterday.dlr-data.php", // json datasource
	...
	<body>
		<div class="header"><h1>Yesterday Delivery Reports for <?php echo $company;?> <h1></div>
		<div class="container">
