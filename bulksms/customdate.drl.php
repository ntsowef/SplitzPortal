...
$_SESSION['date_to'] = $_REQUEST['to_date'];

?>
<html>
  <title>Custom Delivery Reports <?php echo $company; ?></title>
	<head>
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				var dataTable = $('#nomination-grid').DataTable( {
					...
					"serverSide": true,
					"ajax":{
						url :"custom.dlr-data.php", // json datasource
	...
	<body>
		<div class="header"><h2>Custom Delivery Reports for <?php echo $company;?> from <?php echo $_SESSION['date_from'];?> to <?php echo $_SESSION['date_to'];?><h2></div>
		<div class="container">
