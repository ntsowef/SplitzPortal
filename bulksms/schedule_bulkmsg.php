...
{	//echo"<br>1-2";				
	...
	$file = fopen($fileo, "r") or exit("Unable to open file!");
	...
	$x=strstr($strLine,",");
	  ...
	  else
	  {
		...
		if($credits >= $msgcount and !empty($celnumber) and $celnumber >0)
		{
                       ...
                       $query1="INSERT INTO scheduled_messages(id, message, msisdn, company, username, message_date, schedule_date, status) VALUES('','$message','$celnumber','$company','$username',NOW(),'$schedule_date','Q')";
                       //$query1="INSERT INTO scheduled_messages(id, message, msisdn, queued, message_date, company, username) VALUES('','$message','$celnumber', 'Q','$DateSend','$company','$username')";
			//echo $query1;
	...
	if(substr($x,0,1)==",")
	  ...
	  ?>
		<script language = "javascript" style = "text/javascript"> 
			...
			window.location = "schedule_bulk.php";									
		</script>
             <?php
  mysql_close();
        ?>
