...
?>
<html>
  <title>Monthly Delivery Reports <?php echo $company; ?></title>
	<head>
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				var dataTable = $('#nomination-grid').DataTable( {
					...
					"serverSide": true,
					"ajax":{
						url :"monthly.dlr-data.php", // json datasource
	...
	<body>
		<div class="header"><h1>Monthly Delivery Reports for <?php echo $company;?> <h1></div>
		<div class="container">
