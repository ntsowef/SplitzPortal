...
?>
<html>
  <title>Today Delivery Reports <?php echo $company; ?></title>
	<head>
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				var dataTable = $('#nomination-grid').DataTable( {
					...
					"serverSide": true,
					"ajax":{
						url :"today.dlr-data.php", // json datasource
	...
	<body>
		<div class="header"><h1>Today Delivery Reports for <?php echo $company;?> <h1></div>
		<div class="container">
