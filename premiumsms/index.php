...
<?php	
	...
	echo " managed to loggin with ".$username."  password ".$password;
   ...
   echo $query;
	...
	{ echo " managed to loggin with ";
	  list($id,$username,$password,$company,$acc,$accounttype_p,$accounttype_o )=mysql_fetch_row($result);
	  ?> 
